...
class Template(Enum):
    ...
    # * 3x3 Simetric
    SQUARE_9 = lambda w, h, m: [
        [m, m, int(w/3-m*1.5), int(h/3-m*1.5)],
        [int((w/3)+m/2), m, int(w/3-m*1.5), int(h/3-m*1.5)],
        [int((w/3)*2+m/2), m, int(w/3-m*1.5), int(h/3-m*1.5)],
        [m, int((h/3)+m/2), int(w/3-m*1.5), int(h/3-m*1.5)],
        [int((w/3)+m/2), int((h/3)+m/2), int(w/3-m*1.5), int(h/3-m*1.5)],
        [int((w/3)*2+m/2), int((h/3)+m/2), int(w/3-m*1.5), int(h/3-m*1.5)],
        [m, int((h/3)*2+m/2), int(w/3-m*1.5), int(h/3-m*1.5)],
        [int((w/3)+m/2), int((h/3)*2+m/2), int(w/3-m*1.5), int(h/3-m*1.5)],
        [int((w/3)*2+m/2), int((h/3)*2+m/2), int(w/3-m*1.5), int(h/3-m*1.5)]
    ]
